...
<template>
  <div class="p-4 md:p-6 lg:p-24 w-full text-white normal-case flex flex-col justify-center items-center backround-img">
    <div class="max-w-full md:w-1/2 gap-2 flex flex-col justify-center items-center overflow-hidden">
      ...
      <p class="mt-4">
        ...
        <strong>elements</strong>. You can pass a set of elements as a v-model to the Vue Flow component.
        <span class="font-bold">Each element needs a unique id.</span> A node needs a position (x and y) and an edge needs a
